...
VK_IMPORT(vkDestroyRenderPass)
VK_IMPORT(vkDestroyImageView)
VK_IMPORT(vkDestroyImage)
VK_IMPORT(vkFreeMemory)
VK_IMPORT(vkDestroySampler)
VK_IMPORT(vkDestroyFramebuffer)
VK_IMPORT(vkDestroySwapchainKHR)
VK_IMPORT(vkDestroySemaphore)
VK_IMPORT(vkDestroyCommandPool)
VK_IMPORT(vkDestroyBuffer)
VK_IMPORT(vkDestroyShaderModule)
VK_IMPORT(vkDestroyPipeline)
VK_IMPORT(vkDestroyPipelineCache)
VK_IMPORT(vkDestroyPipelineLayout)
VK_IMPORT(vkFreeDescriptorSets)
VK_IMPORT(vkDestroyDescriptorSetLayout)
VK_IMPORT(vkDestroyDescriptorPool)
